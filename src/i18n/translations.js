  ...
  es: {
    ...
    contact: {
      ...
      form: {
        ...
        uploadTitle: 'Adjunta un archivo (opcional)',
        uploadHint: 'Haz clic o arrastra un archivo aquí (máx. 5)',
  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        uploadTitle: 'Attach a file (optional)',
        uploadHint: 'Click or drag a file here (max. 5)',
